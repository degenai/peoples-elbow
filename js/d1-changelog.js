...
class D1Changelog {
    ...
    createTimelineItem(entry, index) {
        ...
        // Prevent XSS by using escapeHtml for all string interpolation within innerHTML
        // even for fields like hash and email which are expected to be safe formats.
        item.innerHTML = `
