...
## 2026-06-15 - Smooth Scrolling for Anchors
**Learning:** Native smooth scrolling for anchor links is a low-effort, high-impact UX improvement that avoids jarring page jumps, but it needs to be set globally.
**Action:** Apply `scroll-behavior: smooth` to the `html` selector in base CSS files.
